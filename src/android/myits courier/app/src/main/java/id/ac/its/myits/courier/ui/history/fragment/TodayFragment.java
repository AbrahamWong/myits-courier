...
//        columnCount = getArguments().getInt(ARG_COLUMN_COUNT);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (v instanceof RecyclerView) {
            ...
            TodayRecyclerViewAdapter adapter = new TodayRecyclerViewAdapter(Today.ITEMS, todayItem -> {
                Intent historyIntent = new Intent(getContext(), HistoryDetailActivity.class);
                historyIntent.putExtra("SBINALLA", String.valueOf(todayItem));

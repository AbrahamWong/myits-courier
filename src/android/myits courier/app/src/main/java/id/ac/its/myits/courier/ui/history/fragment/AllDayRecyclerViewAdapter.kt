...
/*
 * ADAPTER INI BELUM MENGHANDLE header tanggal: fragment_history_header_date
 */

class AllDayRecyclerViewAdapter(
        private val values: List<AllDay.AllDayItem>,
        private val listener: (AllDay.AllDayItem) -> Unit
    ...
    sealed class ViewItem(val resource: Int) {
        class DateItem(val posted: LocalDateTime) : ViewItem(R.layout.fragment_history_header_date)
        class Item(val item: AllDay.AllDayItem) : ViewItem(R.layout.fragment_history_item)
    }
}